...
- [ ] **Selftest** — `./setup.sh selftest` passes locally (smoke + install/uninstall harness)
- [ ] **Idempotency** — `./setup.sh install` tested twice in a row without errors or duplicate entries
